        ...
        <div className="mb-4 flex items-center justify-between gap-6">
          ...
          {examLimit !== null && pastExams.length >= examLimit ? (
            ...
            <Button
              ...
              disabled={isStarting}
              size="lg"
              className="shrink-0 h-14 px-10 text-base font-semibold bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-xl shadow-orange-200 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] active:scale-[0.98]"
            >
              {isStarting ? (
                <div className="flex items-center gap-3">
